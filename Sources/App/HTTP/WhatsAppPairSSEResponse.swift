...
/// SSE response generator for the WhatsApp pairing stream. Mirrors
/// `HermesGatewayApplySSEResponse`: one JSON-encoded `HermesWhatsAppPairEvent`
/// per `data:` line, blank-line terminated, `.iso8601` dates.
struct WhatsAppPairSSEResponse: ResponseGenerator {
    let events: AsyncThrowingStream<HermesWhatsAppPairEvent, Error>
